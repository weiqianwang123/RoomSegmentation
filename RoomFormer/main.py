...
def get_args_parser():
    ...
    parser.add_argument('--resume', default='/home/yfx/RoomFormer/checkpoints/roomformer_stru3d.pth', help='resume from checkpoint')
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        val_log_dict = {
                ...
                "val_metrics/ap_50" : test_stats['ap_50']
                }
